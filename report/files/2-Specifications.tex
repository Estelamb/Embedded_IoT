...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.25\textwidth}p{0.25\textwidth}p{0.2\textwidth}}
        ...
        Leaf Colour & TCS34725 & \gls{I2C} / Digital  \\ 
        Accelerometer & MMA8451Q & \gls{I2C} / Digital  \\ 
        Global Location & Adafruit \gls{GPS} & \gls{UART} / Digital  \\ 
...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.2\textwidth}p{0.6\textwidth}}
        ...
        \midrule
        Zephyr \gls{OS} & \gls{RTOS} for \gls{ARM} Cortex-M devices, used for all system tasks and drivers. \\ 
...
\begin{table}[H]
    ...
    \begin{tabular}{p{0.08\textwidth}p{0.2\textwidth}p{0.55\textwidth}}
        ...
        GR1 & Robustness & System must be stable and robust \\ 
        GR2 & Thread Management & Tasks must be partitioned using multitasking \\ 
        \bottomrule
    \end{tabular}
\end{table}
